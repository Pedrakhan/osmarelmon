...
public class SyndFeedImpl implements Serializable, SyndFeed {
	...
	private Timestamp tmpstmp = null;
	...
	public static final Set CONVENIENCE_PROPERTIES = Collections
	...
	public List getContributors() {
		return (_contributors == null) ? (_contributors = new ArrayList())
				: _contributors;
	}
	...
	public Object getForeignMarkup() {
		return (_foreignMarkup == null) ? (_foreignMarkup = new ArrayList())
				: _foreignMarkup;
	}
	...
	@Override
	public void setLastVisited(Timestamp tmpstmp) {
